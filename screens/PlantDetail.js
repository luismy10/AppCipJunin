...
const PlantDetail = ({ navigation }) => {
        ...
        return (
            ...
            >
                ...
                <View style={{ flexDirection: 'row', marginTop: "5%" }}>
                    <View style={{ flex: 1 }}>
                        <Text style={{ color: COLORS.white, ...FONTS.h1 }}>Glory Mantas</Text>
                    </View>
    ...
    function renderRequirements() {
        return (
            <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding, justifyContent: 'space-around' }}>
                <RequirementDetail
                    icon={icons.sun}
                    label="Sunlight"
                    detail="15°C"
