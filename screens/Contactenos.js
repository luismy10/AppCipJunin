...
import { StyleSheet, View,Text, StatusBar,ScrollView, Image, Linking} from 'react-native';
          ...
          <ScrollView style={{ flex: 1, backgroundColor:COLORS.lightGray}} showsVerticalScrollIndicator={false}> 
            <View style={styles.container}>
              <View style={{paddingBottom:20, width:SIZES.width, height:SIZES.height * 0.25}}>
                <Image source={images.colegio} style={{borderBottomLeftRadius:20, borderBottomRightRadius:20}}/>
              </View>
              <View style={{backgroundColor:'white', width:SIZES * 0.8, margin:20, borderRadius:20}}>
